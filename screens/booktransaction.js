...
import {Text,View,StyleSheet,Button,TouchableOpacity,KeyboardAvoidingView,ToastAndroid,TextInput,Image} from 'react-native';
  ...
  this.setState({
   ...
   buttonState: 'normal'
    ...
    initiateBookIssue = async ()=>{
      //add a transactionin the database
      ...
      //updating the book availablity to false
...
db.collection("books").doc(this.state.scannedBookId).collection(get)
.then((doc)=>{
var book = doc.data()
